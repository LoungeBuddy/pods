...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Jessica Lam"
  # s.authors            = { "Jessica Lam" => "jessica@loungebuddy.com" }
  # s.social_media_url   = "http://twitter.com/Jessica Lam"
  ...
  s.source       = { :git => "https://github.com/LoungeBuddy/LBStyledLabel.git", :tag => "0.0.2" }
